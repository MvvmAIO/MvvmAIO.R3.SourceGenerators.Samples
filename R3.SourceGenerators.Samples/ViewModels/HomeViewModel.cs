...
public sealed class HomeViewModel : ViewModelBase
{
    ...
    public string Sections =>
        ...
        + "• ObservableEvents · inheritance — <c>FromEvents()</c> returns <c>IIssuerDerivedEvents</c> with interface inheritance mirroring <c>IssuerDerived : IssuerBase</c>.\n"
        + "• ObservableEvents · generic constraints — <c>where T : ConstraintBase, IContributor, IAuditor</c>; one combined event interface, no per-constraint casts.";
}
